    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-[#F3EE33]/10 to-[#007628]/10 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.div
          ...
          className="space-y-2 md:space-y-4 -mt-40 md:mt-0"
        >
          ...
          >
            <a href="#contact" className="group flex items-center space-x-2 px-8 py-2 md:py-4 bg-[#007628] text-white rounded-full hover:bg-[#005d1f] transition-all duration-300 font-kannada-regular text-base md:text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1">
              <span>BUY MAIZE</span>
        ...
        >
          <div className="w-6 h-10 border-2 border-[#007628] rounded-full flex justify-center items-start pt-1.5 bg-transparent">
            <motion.div
              animate={{ y: [0, 6, 0] }}
              transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
              className="w-0.5 h-1.5 bg-[#007628] rounded-full"
            ></motion.div>
          </div>
        </motion.div>
